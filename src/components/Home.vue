<template>
  ...
  >
    ...
    <div class="bg" aria-hidden="true">
      <!-- FOTO (troca automaticamente desktop/mobile no CSS) -->
...
<style scoped>
/* =========
  COMO SALVAR AS IMAGENS (recomendado)
  Desktop: 2560x1440 (ou 1920x1080 se quiser mais leve)
  Mobile: 1080x1920 (vertical)
  Arquivos:
    src/assets/hero-gritador-desktop.png
    src/assets/hero-gritador-mobile.png
========= */
...
/* FOTO: aqui acontece o “não quebrar layout” */
.bg__photo{
  position:absolute;
  inset: 0;
  background-image: url("./bg/bgD.png");
...
/* Mobile usa uma foto vertical (evita cortar demais) */
@media (max-width: 1024px){
  .bg__photo{
    background-image: url("./bg/bgM.png");
...
.bg__overlay--vignette{
  background: radial-gradient(900px 520px at 18% 14%, rgba(0,0,0,0.10), rgba(0,0,0,0.55));
}
.bg__overlay--tint{
  background:
    radial-gradient(700px 380px at 20% 10%, rgba(47,73,255,0.22), transparent 60%),
    radial-gradient(700px 420px at 75% 25%, rgba(255,47,179,0.12), transparent 60%),
    linear-gradient(180deg, rgba(2,6,23,0.65), rgba(2,6,23,0.80));
...
.btn--primary{
  ...
  background: linear-gradient(90deg, rgba(47,73,255,0.92), rgba(255,47,179,0.78), rgba(46,242,177,0.78));
...
@media (max-width: 1024px){
  ...
  .shard{ display:none; } /* no mobile fica mais limpo e leve */
}

/* A11y */
@media (prefers-reduced-motion: reduce){
  .pulse{ animation: none !important; }
  .btn,.chip,.miniCta,.right{ transition:none !important; }
}
</style>